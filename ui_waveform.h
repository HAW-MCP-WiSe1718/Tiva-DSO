...
#define UI_WAVEFORM_GRID_TOPBOUNDARY_THICKNESS 3
...
#define UI_WAVEFORM_WAVE_COLOR GRAPHICS_YELLOWCOLOR
...
void vUIWaveformUpdateWave(int16_t*);
void vUIWaveformUpdateWaveSingle(int16_t*,uint16_t);
void vUIWaveformUpdatePartOfWave(int16_t*,uint16_t,uint16_t);
