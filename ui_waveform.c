 ...
 *                                                                           */
void vUIWaveformUpdatePartOfWave(int16_t* p_aiSampleBuffer,uint16_t uiX_Start,uint16_t uiX_End,tuGraphicsColor waveColor)
{
    uint16_t uiBufferCounter=0;
    ...
    vUIWaveformPrintPartOfWave(0,479,waveColor);
 ...
 *
 *                                                                           */
void vUIWaveformUpdateWaveSingle(int16_t* p_aiSampleBuffer,uint16_t uiX,tuGraphicsColor waveColor)
{
    vUIWaveformUpdatePartOfWave(p_aiSampleBuffer,uiX,uiX,waveColor);
}
 ...
 *
 *                                                                           */
void vUIWaveformUpdateWave(int16_t* p_aiSampleBuffer,tuGraphicsColor waveColor)
{
    vUIWaveformUpdatePartOfWave(p_aiSampleBuffer,UI_WAVEFORM_WAVEXSTART,UI_WAVEFORM_WAVEXEND,waveColor);
}
