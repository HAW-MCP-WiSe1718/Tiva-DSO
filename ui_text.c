...
uint8_t aucTextGlyphLUT[TEXT_NUMBEROFCHARACTERS][TEXT_NUMBEROFGLYPHROWS]=
    {TEXT_BLANK, TEXT_RESERVED,TEXT_RESERVED,TEXT_RESERVED,TEXT_RESERVED,TEXT_RESERVED,TEXT_RESERVED,
     ...
     TEXT_COLON,TEXT_RESERVED,TEXT_DELTA /*<*/,TEXT_EQUAL,TEXT_RESERVED,TEXT_RESERVED,TEXT_RESERVED,
...
void vTextEraseLine(tsGraphicsCoord lineCoord, uint16_t length)
{
    ...
    for(uiRowCounter=0;uiRowCounter<TEXT_NUMBEROFGLYPHROWS;uiRowCounter++)
    {
        for(uiColumnCounter=0;uiColumnCounter<(TEXT_NUMBEROFGLYPHCOLUMNS+1)*length;uiColumnCounter++)           //blacks out every pixel in selected textfield
        {
